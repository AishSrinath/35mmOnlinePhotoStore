...
<div id="tbl_container_demo_grid1" class="table-responsive">
   <div class="basketOuter">
	   ...
	   ?>	   
           <p><?php=$row['cart_qty'] ?> x <?=$row['cart_pname']?> (<img src="./images/euro.jpg" border="0" style="border:none;"  height="42" width="42" /><?php echo number_format($row['cart_qty']*$row['cart_price'],2)?>)</p>
       <?php
	   		}
		...
		?>	     
            ...
            <p class="postageTotal"><span>Subtotal:</span><img src="./images/euro.jpg" border="0" style="border:none;"  height="42" width="42" /><?php echo number_format($tot,2) ?></p>
